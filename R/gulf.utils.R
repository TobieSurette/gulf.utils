#' gulf.utils: sGSL Utility Functions
#'
#' A package of basic utility functions for use in the southern Gulf of Saint Lawrence fisheries' science.
#'
#' @section Functions and Methods:
#' \describe{
#'    \item{\code{\link{date}}}{Date formatting functions.}
#'    \item{\code{\link{deblank}}}{Remove leading and trailing blanks in character strings.}
#'    \item{\code{\link{describe}}}{Return descriptive data summaries.}
#'    \item{\code{\link{dir.github}}}{Return file contents of a GitHub repository.}
#'    \item{\code{\link{eps}}}{Return machine floating point precision.}
#'    \item{\code{\link{excel}}}{Output data in MS Excel.}
#'    \item{\code{\link{is.installed}}}{Check if R package is installed.}
#'    \item{\code{\link{lexicon}}}{Return word content in text or data.}
...
#'    \item{\code{\link{sort.data.frame}}}{Sort data frame.}
#'    \item{\code{\link{subset.list}}}{Return subset of a list object.}
